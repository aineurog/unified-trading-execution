...
_RET_CODE_MAP: dict[int, type[UteError]] = {
    ...
    110051: InsufficientBalanceError,  # "balance cannot cover lowest price of current market"
    110052: InsufficientBalanceError,  # "insufficient balance to set the price"
    110053: InsufficientBalanceError,  # "balance cannot cover market price and upper limit price"
